package baguchan.slash_illager.animation;
...
import static baguchan.slash_illager.client.ClientRenderingRegistry.MotionLocation;
...
public class VanillaConvertedVmdAnimation {
    ...
    public VanillaConvertedVmdAnimation getClone(){
        VanillaConvertedVmdAnimation tmp = new VanillaConvertedVmdAnimation(MotionLocation, this.start ,this.end ,this.loop);
...
//        double a_z_y = 2 * (qt.y * qt.z - qt.w * qt.x);
    ...
    public void setupAnim() {
        ...
        double time = TimeValueHelper.getMSecFromTicks((float)(currentTick + this.tickDelta));
